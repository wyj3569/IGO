...
# hospital : 병원 정보
# real_distance : 환자와 기지국 사이의 거리 값 4개 tuple
def get_drawing_patient_position(hospital: Hospital, real_distance: tuple) -> tuple:
    ...
    real_station4_x, real_station4_y = hospital.real_station4_x, hospital.real_station4_y
    ...
    real_patient_x, real_patient_y = polypoint(
        ...
        real_station4=(real_station4_x, real_station4_y)
    )
    print("실제 환자의 위치")
...
def polypoint(real_distance: tuple,
              ...
              real_station2: tuple,
              real_station3: tuple,
              real_station4: tuple) -> tuple:
    # 환자와 기지국 사이의 실제 거리들 r1, r2, r3, r4
    real_distance1, real_distance2, real_distance3, real_distance4 = real_distance
    # 실제 병원에서 기지국 위치
    ...
    real_station4_x, real_station4_y = real_station4  # (x4, y4)
